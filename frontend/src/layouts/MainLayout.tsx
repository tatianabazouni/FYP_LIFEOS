...
import {
  ...
  Trophy, Sparkles, Users, ChevronLeft,
  Menu, Archive, LogOut
} from "lucide-react";
...
export default function MainLayout() {
  ...
  const title = routeTitle[location.pathname] || "LifeOS";
    ...
    <div className="min-h-screen bg-background flex">
      ...
      >
        <div className="h-16 flex items-center px-4 gap-3 border-b border-sidebar-border">
          <Link to="/dashboard" className="w-8 h-8 rounded-lg gradient-hero flex items-center justify-center shrink-0">
