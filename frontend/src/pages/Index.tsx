        ...
        <div className="max-w-4xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              LifeOS helps you journal, set goals, build vision boards, and grow with AI-powered insights.
            </p>
          </motion.div>
          ...
          >
            <Link
              to="/register"
              className="px-8 py-3.5 rounded-xl gradient-hero text-primary-foreground font-semibold shadow-elevated hover:opacity-90 transition-all"
            >
              Start Your Journey
            </Link>
            <a
              href="#features"
              className="px-8 py-3.5 rounded-xl bg-card border border-border font-semibold shadow-card hover:shadow-elevated transition-all text-foreground"
            >
              Explore Features
            </a>
          </motion.div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Powerful tools designed around real life growth and reflection.
            </p>
          </div>
